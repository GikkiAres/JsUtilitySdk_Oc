 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `JsYy_Model` protocol for custom methods.
 
 
 Sample Code:
    
     ********************** json convertor *********************
     @interface JsYy_Author : NSObject
     @property (nonatomic, strong) NSString *name;
     @property (nonatomic, assign) NSDate *birthday;
     @end
     @implementation JsYy_Author
     @end
 
     @interface JsYy_Book : NSObject
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) NSUInteger pages;
     @property (nonatomic, strong) JsYy_Author *author;
     @end
     @implementation JsYy_Book
     @end
    
     int main() {
         // create model from json
         JsYy_Book *book = [JsYy_Book jsyy_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 
         // convert model to json
         NSString *json = [book jsyy_modelToJSONString];
         // {"author":{"name":"J.K.Rowling","birthday":"1965-07-31T00:00:00+0000"},"name":"Harry Potter","pages":256}
     }
 
     ********************** Coding/Copying/hash/equal *********************
     @interface JsYy_Shadow :NSObject <NSCoding, NSCopying>
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) CGSize size;
     @end
 
     @implementation JsYy_Shadow
     - (void)encodeWithCoder:(NSCoder *)aCoder { [self jsyy_modelEncodeWithCoder:aCoder]; }
     - (id)initWithCoder:(NSCoder *)aDecoder { self = [super init]; return [self jsyy_modelInitWithCoder:aDecoder]; }
     - (id)copyWithZone:(NSZone *)zone { return [self jsyy_modelCopy]; }
     - (NSUInteger)hash { return [self jsyy_modelHash]; }
     - (BOOL)isEqual:(id)object { return [self jsyy_modelIsEqual:object]; }
     @end
 
 */
@interface NSObject (JsYy_Model)
 ...
 */
+ (nullable instancetype)jsyy_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)jsyy_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (BOOL)jsyy_modelSetWithJSON:(id)json;
...
/**
 ...
 @return Whether succeed.
 */
- (BOOL)jsyy_modelSetWithDictionary:(NSDictionary *)dic;
 ...
 */
- (nullable id)jsyy_modelToJSONObject;
 ...
 */
- (nullable NSData *)jsyy_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)jsyy_modelToJSONString;
 ...
 */
- (void)jsyy_modelEncodeWithCoder:(NSCoder *)aCoder;
...
/**
 ...
 @return self
 */
- (id)jsyy_modelInitWithCoder:(NSCoder *)aDecoder;
 ...
 */
- (BOOL)jsyy_modelIsEqual:(id)model;
 ...
 */
- (NSString *)jsyy_modelDescription;
 ...
 */
+ (nullable NSArray *)jsyy_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (JsYy_Model)
 ...
 */
+ (nullable NSDictionary *)jsyy_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<JsYy_Model>' to your class header.
 */
@protocol JsYy_Model <NSObject>
@optional
...
/**
 ...
 object will be add to the array/set/dictionary.
  ...
  Example:
        @class JsYy_Shadow, JsYy_Border, JsYy_Attachment;
 
        @interface JsYy_Attributes
        @property NSString *name;
        ...
        @implementation JsYy_Attributes
        + (NSDictionary *)modelContainerPropertyGenericClass {
            return @{@"shadows" : [JsYy_Shadow class],
                     @"borders" : JsYy_Border.class,
                     @"attachments" : @"JsYy_Attachment" };
        }
        @end
...
/**
 ...
 Example:
        @class JsYy_Circle, JsYy_Rectangle, JsYy_Line;
 
        @implementation JsYy_Shape

        + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
            if (dictionary[@"radius"] != nil) {
                return [JsYy_Circle class];
            } else if (dictionary[@"width"] != nil) {
                return [JsYy_Rectangle class];
            } else if (dictionary[@"y2"] != nil) {
                return [JsYy_Line class];
            } else {
                return [self class];
            }
        }
