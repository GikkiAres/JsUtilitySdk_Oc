...
@property (nonatomic,strong) NSString * initalContent;

-(instancetype)initWithLogDirPath:(NSString *)logDirPath maxFileCount:(int)maxFileCount initalContent:(NSString *)initalContent;
